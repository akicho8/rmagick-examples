...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFf5d6a3, (int)0xFFfaead1)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/board/groovy_board_texture14.png"))
