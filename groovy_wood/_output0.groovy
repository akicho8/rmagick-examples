...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFf5dea3, (int)0xFFf2d58c)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/piece/groovy_piece_texture01.png"))