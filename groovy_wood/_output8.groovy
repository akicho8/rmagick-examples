...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFcdba8b, (int)0xFFd5c59d)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/board/groovy_board_texture09.png"))
