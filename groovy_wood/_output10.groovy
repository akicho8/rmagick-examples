...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFe69719, (int)0xFFebac47)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/board/groovy_board_texture11.png"))
