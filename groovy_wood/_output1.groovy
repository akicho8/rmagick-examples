...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFf7e6ba, (int)0xFFf5dea3)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/piece/groovy_piece_texture02.png"))