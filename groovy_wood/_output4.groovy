...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFb88914, (int)0xFFa17812)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/piece/groovy_piece_texture05.png"))