...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFebac47, (int)0xFFf0c175)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/board/groovy_board_texture12.png"))
