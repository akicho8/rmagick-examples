...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFc9b582, (int)0xFFd1c094)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/board/groovy_board_texture08.png"))
