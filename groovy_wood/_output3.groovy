...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFe6ac19, (int)0xFFcf9b17)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/piece/groovy_piece_texture04.png"))