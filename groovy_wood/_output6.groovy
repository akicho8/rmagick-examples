...
wf.setFibres(0)                           // 繊維の量
def lc = new LinearColormap((int)0xFFc6b079, (int)0xFFcdba8b)
wf.setColormap(lc)

img = wf.filter(img, null)
ImageIO.write(img, "png", new File("../../bioshogi/lib/bioshogi/assets/images/board/groovy_board_texture07.png"))
